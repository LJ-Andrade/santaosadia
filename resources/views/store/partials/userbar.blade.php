    ...
    <div class="inner">
        <div class="tools">
            ...
            <div class="account"><a href="#" onclick="event.preventDefault();"></a>
                ...
                @if(isset($activeCart))
                <div class="cart"><i class="icon-bag"></i><span class="count">{{ $activeCart['totalItems'] }}</span>
                    ...
                    <div class="toolbar-dropdown toolbar-user-dropdown">
                        @foreach($activeCart['rawdata']->items as $item)
                            <div class="dropdown-product-item">
                                <span class="RemoveArticleFromCart dropdown-product-remove" data-detailid="{{ $item->id }}">
